            ...
            children: [
              TextFormField(
                decoration: InputDecoration(
                    ...
                    hintText: 'Search...'),
                onChanged: (value) {
                  Get.find<StudentController>().searchText.value = value;
                },
              ),
              GetX<StudentController>(builder: (searchController) {
                var result = searchController.searchText.isEmpty
                    ? box.values.toList()
                    : box.values
                        .where((element) => element.name.toLowerCase().contains(
                            searchController.searchText.toLowerCase()))
                        .toList();
                return searchController.searchText.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, intex) {
                          ...
                          var get = box.values
                              .where((a) => a.name.contains(result[intex].name))
                              .toList();
